...
CREATE TABLE Picks (
    ...
    predicted_second_id INT,
    predicted_third_id INT,
    predicted_fourth_id INT,
    FOREIGN KEY (user_competition_id) REFERENCES UserCompetitions(user_competition_id) ON DELETE CASCADE,
    FOREIGN KEY (event_id) REFERENCES CompetitionEvent(event_id) ON DELETE CASCADE,
    FOREIGN KEY (predicted_winner_id) REFERENCES Swimmers(swimmer_id),
    FOREIGN KEY (predicted_second_id) REFERENCES Swimmers(swimmer_id),
    FOREIGN KEY (predicted_third_id) REFERENCES Swimmers(swimmer_id),
    FOREIGN KEY (predicted_fourth_id) REFERENCES Swimmers(swimmer_id),
